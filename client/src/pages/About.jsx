      ...
      <section className="text-center">
        ...
        <div className="flex flex-col md:flex-row gap-12 justify-center items-center mt-12">
          <div className="pb-4 border flex flex-col items-center">
            <img src="src\assets\samia.png" alt="Team Member" className="w-80" />
            <h3 className="mt-4">Mehrab Ahmad</h3>
            <p>CEO</p>
          </div>

          <div className="pb-4 border flex flex-col items-center">
            <img src="src\assets\naveed.png" alt="Team Member" className="w-80" />
        ...
        <div className="flex flex-col md:flex-row gap-12 justify-center items-center mt-12">
          <div className="pb-4 border flex flex-col items-center">
            <img src="src\assets\male_ph.jpg" alt="Team Member" className="w-80" />
          ...
          <div className="pb-4 border flex flex-col items-center">
            <img src="src\assets\female_ph.jpg" alt="Team Member" className="w-80" />
